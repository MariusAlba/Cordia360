  ...
  return (
    <div>
        ...
        <div className=" aboutTop">
                <h1 className="display-4 justify-content-center">Case Studies</h1>   
        </div>
        <Stack direction="horizontal" gap={3}>
            ...
            <b className="p-2">IKDRC Case Study - Remote Monitoring of Pregnancy</b>
        ...
        <Stack direction="horizontal" gap={3}>
            ...
            <b className="p-2">SGPGI Case Study - Transforming Maternal Healthcare Through
            Remote Monitoring</b>
            <div className="p-2 ms-auto"><Button> Read more</Button></div>
        ...
        <Stack direction="horizontal" gap={3}>
            ...
            <b className="p-2">Enhancing Healthcare Innovation: Sophia Akash Foundation's Strategic
            Advisory Role with vCare Denmark ApS</b>
            <div className="p-2 ms-auto"><Button> Read more</Button></div>
